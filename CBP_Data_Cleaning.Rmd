...
# from the session's working directory. Without this, running chunks from the
# wrong directory makes here() point elsewhere, list.files() quietly returns
# nothing, and the failure only surfaces later as a missing-column error.
here::i_am("CBP_Data_Cleaning.Rmd")

# Run log. Appends to logs/CBP_Data_Cleaning.log; see log_setup.R.
...
log_info(sprintf("read %d CBP files for 2014-2016", length(files_2014_2016)))
log_dim("cbp_2014_2016_all", cbp_2014_2016_all)
...
log_dim("cbp_2012_2013_all", cbp_2012_2013_all)
...
log_dim("cbp_2017_2022_all", cbp_2017_2022_all)
...
log_info(sprintf("counties: %d, years: %s",
                 length(unique(cbp_2012_2022$GEO_ID)),
                 paste(range(cbp_2012_2022$YEAR), collapse = "-")))
```
...
ggsave(here("Figures", "NAICS_map.pdf"), naics_map, width = 12, height = 8, bg = "white")
